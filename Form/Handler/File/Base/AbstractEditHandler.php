...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function getFormOptions()
    {
        $options = [
            ...
            'allow_moderation_specific_creator' => $this->variableApi->get('RKDownLoadModule', 'allowModerationSpecificCreatorFor' . $this->objectTypeCapital, false),
            'allow_moderation_specific_creation_date' => $this->variableApi->get('RKDownLoadModule', 'allowModerationSpecificCreationDateFor' . $this->objectTypeCapital, false),
        ];
    ...
    protected function getRedirectUrl(array $args = [])
    {
        ...
        if ($session->has('rkdownloadmodule' . $this->objectTypeCapital . 'Referer')) {
            $this->returnTo = $session->get('rkdownloadmodule' . $this->objectTypeCapital . 'Referer');
            $session->remove('rkdownloadmodule' . $this->objectTypeCapital . 'Referer');
        }
