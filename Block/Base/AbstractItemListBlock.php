...
use RK\DownLoadModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    {
        return $this->__('Down load list', 'rkdownloadmodule');
    }
    ...
    public function display(array $properties = [])
    {
        ...
        // create query
        $orderBy = $this->get('rk_download_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('Down load list', 'rkdownloadmodule');
        }
        ...
        $templateParameters = $this->get('rk_download_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    public function getFormOptions()
    {
        ...
        return [
            ...
            'category_helper' => $this->get('rk_download_module.category_helper'),
            'feature_activation_helper' => $this->get('rk_download_module.feature_activation_helper')
        ];
    }
