...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function getEditorHelpers(EditorHelperEvent $event)
    {
        ...
        $event->getHelperCollection()->add(
            [
                ...
                'type' => 'javascript',
                'path' => $this->requestStack->getCurrentRequest()->getBasePath() . '/web/modules/rkdownload/js/RKDownLoadModule.Finder.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            ...
            'path' => $this->requestStack->getCurrentRequest()->getBasePath() . '/web/modules/rkdownload/scribite/CKEditor/rkdownloadmodule/',
            'file' => 'plugin.js',
    ...
    public function getQuillPlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'rkdownloadmodule',
            'path' => $this->requestStack->getCurrentRequest()->getBasePath() . '/web/modules/rkdownload/scribite/Quill/rkdownloadmodule/plugin.js'
        ]);
    }
    ...
    public function getSummernotePlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'rkdownloadmodule',
            'path' => $this->requestStack->getCurrentRequest()->getBasePath() . '/web/modules/rkdownload/scribite/Summernote/rkdownloadmodule/plugin.js'
        ]);
    }
    ...
    public function getTinyMcePlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'rkdownloadmodule',
            'path' => $this->requestStack->getCurrentRequest()->getBasePath() . '/web/modules/rkdownload/scribite/TinyMce/rkdownloadmodule/plugin.js'
        ]);
    }
}
