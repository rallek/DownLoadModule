...
abstract class AbstractExternalController extends AbstractController
{
    ...
    public function displayAction(Request $request, $objectType, $id, $source, $displayMode)
    {
        ...
        if (!$this->get('rk_download_module.permission_helper')->mayRead($entity)) {
            return new Response('');
        }
    ...
    {
        $listEntriesHelper = $this->get('rk_download_module.listentries_helper');
        ...
        if (!$this->get('rk_download_module.permission_helper')->hasComponentPermission($objectType, ACCESS_COMMENT)) {
            throw new AccessDeniedException();
        }
