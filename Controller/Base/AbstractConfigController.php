...
abstract class AbstractConfigController extends AbstractController
{
    ...
    {
        if (!$this->get('rk_download_module.permission_helper')->hasPermission(ACCESS_ADMIN)) {
            throw new AccessDeniedException();
        }
        
        $form = $this->createForm(ConfigType::class, $this->get('rk_download_module.app_settings'));
