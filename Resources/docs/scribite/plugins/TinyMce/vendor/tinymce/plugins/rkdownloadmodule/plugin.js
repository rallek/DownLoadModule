...
(function () {
    ...
    tinymce.PluginManager.requireLangPack('rkdownloadmodule', 'de,en,nl');
    ...
    tinymce.create('tinymce.plugins.RKDownLoadModulePlugin', {
        ...
        init: function (ed, url) {
            ...
            ed.addButton('rkdownloadmodule', {
                title: 'rkdownloadmodule.desc',
                cmd: 'mceRKDownLoadModule',
                image: Zikula.Config.baseURL + 'modules/RK/DownLoadModuleResources/public/images/admin.png',
    ...
    // Register plugin
    tinymce.PluginManager.add('rkdownloadmodule', tinymce.plugins.RKDownLoadModulePlugin);
}());
