...
use RK\DownLoadModule\ContentType\Form\Type\ItemType as FormType;
...
abstract class AbstractItemType extends AbstractContentType
{
    ...
    {
        return $this->translator->__('Down load detail', 'rkdownloadmodule');
    }
    ...
    {
        return $this->translator->__('Display or link a single down load object.', 'rkdownloadmodule');
    }
    ...
    public function displayView()
    {
        ...
        $controllerReference = new ControllerReference('RKDownLoadModule:External:display', $this->getDisplayArguments(), ['template' => $this->data['customTemplate']]);
    ...
    {
        if (null === $this->data['id'] || empty($this->data['id']) || empty($this->data['displayMode'])) {
            return $this->translator->__('No item selected.', 'rkdownloadmodule');
        }
