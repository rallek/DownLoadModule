...
use RK\DownLoadModule\ContentType\Form\Type\ItemListType as FormType;
...
abstract class AbstractItemListType extends AbstractContentType
{
    ...
    {
        return $this->translator->__('Down load list', 'rkdownloadmodule');
    }
    ...
    {
        return $this->translator->__('Display a list of down load objects.', 'rkdownloadmodule');
    }
    ...
    public function getViewTemplatePath($suffix = '')
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($this->twigLoader->exists('@RKDownLoadModule/' . $templatePath)) {
