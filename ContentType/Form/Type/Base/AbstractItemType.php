...
abstract class AbstractItemType extends AbstractContentFormType
{
    ...
    public function addDisplayModeField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('displayMode', ChoiceType::class, [
            'label' => $this->__('Display mode', 'rkdownloadmodule') . ':',
            'label_attr' => [
                'class' => 'radio-inline'
            ],
            'empty_data' => 'embed',
            'choices' => [
                $this->__('Link to object', 'rkdownloadmodule') => 'link',
                $this->__('Embed object display', 'rkdownloadmodule') => 'embed'
            ],
            'multiple' => false,
            'expanded' => true
        ]);
    ...
    {
        return 'rkdownloadmodule_contenttype_detail';
    }
